...
<body>
  ...
  <a class="p-3 text-white" href="./../../voiranime/index.php"><svg xmlns="http://www.w3.org/2000/svg" width="25"
  ...
  <div class="container">
    ...
    <div class='d-flex justify-content-center p-3'>
      ...
      <iframe class="col-lg-12" width="1100" height="430" src="<?= $anime['video'] ?>" . $video . frameborder="0"
